...
● ' UNION SELECT NULL FROM             : retrieves the database server version. the query varies depending on the database management system, the NULL count should       v$version--                          be same as that found from the above
