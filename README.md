...
● ' UNION SELECT NULL FROM v$version-- : retrieves the database server version. the query varies depending on the database management system, the NULL count should be same as that found from the above
